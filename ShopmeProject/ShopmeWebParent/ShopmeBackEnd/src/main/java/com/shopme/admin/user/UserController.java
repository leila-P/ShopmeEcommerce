...
public class UserController {
	...
	public String updateUserEnabeldStatus(@PathVariable("id") Integer id, @PathVariable("status") boolean enabeld,
			RedirectAttributes redirectAttributes) {
		service.updateUserEnabledStatus(id, enabeld);
		String status = enabeld ? "enabled" : "disabled";
